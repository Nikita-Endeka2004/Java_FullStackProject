...
public class FollowingsViewDto implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        FollowingsViewDto that = (FollowingsViewDto) o;
    ...
    public FollowingsViewDto(Long id, Integer publishing_id, Integer user_id, String name, Long cost, String description, String tags, Integer publicationYear) {
        this.id = id;
        this.publishing_id = publishing_id;
        this.user_id = user_id;
        this.name = name;
